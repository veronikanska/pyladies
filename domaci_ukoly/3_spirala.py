...
# Nejprve zadani poctu stran - nepusti dal, pokud uzivatel nezada pocet v tomto rozmezi
n = 0             
while n < 2 or n > 8:
...
for strana in range(int(200/n),int(1000/n + 100)):         # v range je korekce velikosti spiraly: Cim vetsi n, tim mensi pocatecni delka strany a mensi pocet 'otoceni'
    pencolor(colors[strana % n])                             # barva stopy se meni s kazdou novou stranou / vybira z mnoziny barvy definovane vyse
